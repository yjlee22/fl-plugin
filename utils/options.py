...
def args_parser():
    ...
    parser.add_argument('--num_data', type=int, default=500, help="number of data per client for label skew")
    ...
    parser.add_argument('--ds', type=int, default=100, help="random data size")
    parser.add_argument('--lr', type=float, default=0.001, help="client learning rate")

    parser.add_argument('--plugin', action='store_true', help='tensorboard')
    ...
    parser.add_argument('--temperature', type=float, default=0.5,help='hyper parameter for plugin')
    parser.add_argument('--rho', type=float, default=0.1, help='hyper parameter for fedsam and fedspeed')
